...
import { generateUA, isURL, err } from '../lib/function.js';
			...
			return __generator(this, function (_a) {
					switch (_a.label) {
							case 0:
									...
									return [4 /*yield*/, axios.get("https://pinterestdownloader.io/frontendService/DownloaderService?url=".concat(url), { headers: headers })];
							case 1:
									data = (_a.sent()).data;
									medias = data.medias;
...
export function telegraph(Path) {
	return __awaiter(this, void 0, void 0, function () {
			var form, config, data, fileUrl, error_2;
			return __generator(this, function (_a) {
					switch (_a.label) {
							case 0:
							...
							case 3:
									error_2 = _a.sent();
									err(error_2.message);
									throw new Error(String(error_2));
			...
			return new Promise(function (resolve, reject) {
					...
					if (_this.useCLI) {
							...
							process_1.on('error', function (error) {
									...
									options.onError("ffmpeg error: ".concat(error));
							});
							...
							ffmpeg(_this.Input)
									...
									resolve();
									options.onEnd.apply(options, args);
							})
...
export function fileUguu(filePath) {
	return __awaiter(this, void 0, void 0, function () {
					...
					switch (_a.label) {
							...
							case 1:
									...
									return [4 /*yield*/, axios({
													...
													method: "POST",
													headers: __assign({ "User-Agent": generateUA() }, form.getHeaders()),
													data: form
											})];
							case 2:
									response = _a.sent();
			...
			return __generator(this, function (_b) {
					switch (_b.label) {
							case 0:
									...
									return [4 /*yield*/, axios.get(url).then(function (res) { return cheerio.load(res.data); })];
							case 1:
									$ = _b.sent();

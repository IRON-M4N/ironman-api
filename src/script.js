		...
		return __generator(this, function(_a) {
			switch (_a.label) {
				case 0:
					...
					return [4 /*yield*/ , axios_1.default.get("https://pinterestdownloader.io/frontendService/DownloaderService?url=".concat(url), {
						headers: headers
					})];
				case 1:
					data = (_a.sent()).data;
...
var m3u8 = /** @class */ (function() {
	...
	m3u8.prototype.InputFile = function(filename) {
		if (!filename) throw new Error("Need the path or url");
		this.Input = filename;
		return this;
	};
	m3u8.prototype.OutputFile = function(filename) {
		if (!filename) throw new Error("Need output path");
	...
	m3u8.prototype.start = function(options) {
		...
		return new Promise(function(resolve, reject) {
			...
			if (_this.useCLI) {
				...
				var process_1 = cp.spawn(command, {
					shell: true
				});
				...
				ffmpeg(_this.Input).on('start', options.onStart).on('codecData', options.onCodecData).on('progress', options.onProgress).on("error", function(error) {
					var _a;
					reject(new Error(error));
					(_a = options.onError) === null || _a === void 0 ? void 0 : _a.call(options, error);
				}).on('stderr', options.onStderr).on("end", function() {
					var _a;
					var args = [];
				...
				}).outputOptions("-c copy").outputOptions("-bsf:a aac_adtstoasc").output(_this.Output).run();
			}
		});
	};
	return m3u8;
	...
	return __awaiter(this, void 0, void 0, function() {
		...
		return __generator(this, function(_a) {
			switch (_a.label) {
				...
				case 1:
					_a.trys.push([1, 3, , 4]);
					return [4 /*yield*/ , axios_1.default.post(requestUrl, formData, {
						headers: headers
					})];
				case 2:
					response = _a.sent();
					...
					urls = $_1('a').map(function(index, element) {
